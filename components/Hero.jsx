...
function Hero() {
  ...
  return (
    <div className="w-full md:h-[25rem] md:mt-20 flex flex-col justify-center space-y-3 px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-28">
      <div className="md:text-8xl text-4xl font-medium">{currWord}</div>
      ...
      <div className="space-y-2">
        <div className="text-gray-500 text-2xl">We believe in togetherness</div>
        <div className="flex space-x-5 text-white">
          <div className="bg-yellow-400 px-5 rounded-3xl py-2">Learn</div>

          <div className="bg-blue-400 px-5 rounded-3xl py-2">Collaborate</div>

          <div className="bg-green-400 px-5 rounded-3xl py-2">Grow</div>
        </div>
      </div>
