...
const eventsData = [
  {
    ...
    description:
      "Spreadig the awareness about open source and hacktoberfest to the students of ABESIT.",
  },
  {
    id: 2,
    title: "Twitter Space",
    ...
    description:
      "A space on twitter to discuss how hackathons, open source and communities help in improving resume.",
  },
  {
    id: 3,
    ...
    description:
      "A series of events to help students learn about Google Cloud and get hands-on experience through a series of codelabs.",
  },
];
        ...
        {eventsData.map((event) => (
          ...
          >
            ...
            <Image
              ...
              src={event.img}
              alt={event.title}
              className="w-11/12 mx-auto h-54 object-contain mb-2 rounded-xl shadow-md"
            />
